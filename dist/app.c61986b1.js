...
var container = document.getElementById('root'); // 반환하는 값은 DOM Element
...
}(Api); // getData 는 2가지 유형을 반환한다. newsFeed, newsDetail
...
function newsDetail() {
  ...
  var newsDetail = new NewsDetailApi(CONTENT_URL.replace('@id', id));
  var newsContent = newsDetail.getData();
...
function makeComment(comments) {
  ...
  for (var i = 0; i < comments.length; i++) {
    ...
    commentString.push("\n    <div style=\"padding-left: ".concat(comment.level * 40, "px;\" class=\"mt-4\">\n    <div class=\"text-gray-400\">\n    <i class=\"fa fa-sort-up mr-2\"></i>\n    <string>").concat(comment.user, "</strong> ").concat(comment.time_ago, "\n    </div>\n    <p class=\"text-gray-700\">").concat(comment.content, "</p>\n    </div>\n    "));

    if (comment.comments.length > 0) {
      //재귀 호출. 인자로 called +1을 주어 호출 될 때마다(deps를 1단계씩 더 들어갈 때마다) padding-left의 값을 늘린다.
...
router();
},{}],"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
